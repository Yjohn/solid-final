...
interface FileUploadFormProps {
  onSubmit: (fileData: Omit<PatientFile, "id" | "createdAt" | "updatedAt">) => void;
  onCancel: () => void;
  readOnly?: boolean;
}
...
const FileUploadForm: React.FC<FileUploadFormProps> = ({
  ...
  const [fileType, setFileType] = useState<PatientFile["type"]>("lab");
  const [sharedWithDoctor, setSharedWithDoctor] = useState(true);
  const [sharedWithEmergency, setSharedWithEmergency] = useState(false);
  const [sharedWithNurse, setSharedWithNurse] = useState(true);
  const [sharedWithPharmacy, setSharedWithPharmacy] = useState(false);
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          <h4 className="text-sm font-medium text-gray-700 mb-3">Share with:</h4>
